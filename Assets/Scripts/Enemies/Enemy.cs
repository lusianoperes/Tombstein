...
public class Enemy : MonoBehaviour {
    ...
    public float attackRange; //Distancia a la que el enemigo debe acercarse al jugador para atacar. Tambien es la distancia a la que deja de avanzar
    public float attackCooldown; //Cada cuantos segunos se puede llamar el ataque
    public int projectileSpeed; //Velocidad del projectil disparado por el enemigo
